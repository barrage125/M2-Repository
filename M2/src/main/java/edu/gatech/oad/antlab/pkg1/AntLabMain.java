 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Alexander Lotz");
		  toPrint += p1.toString("alotz3");
		  ...
		  toPrint += p3.toString("gburdell3");
                  ...
                  Person4 p4 = new Person4("Anna K. Klaussen");
                  toPrint += p4.toString("aklaussen3");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Michal");
                  toPrint += p5.toString("mmarble3");
